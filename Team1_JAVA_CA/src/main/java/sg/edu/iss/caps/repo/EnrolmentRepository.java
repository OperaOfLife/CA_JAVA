...
public interface EnrolmentRepository extends JpaRepository<Enrolment, Integer>
{
	...
	@Query("SELECT e FROM Enrolment e WHERE e.student.studentId LIKE :studentid AND e.course.courseId LIKE :courseid") 
	 public Enrolment findEnrolmentByCourseAndStudentId(@Param("studentid") String studentid, @Param("courseid") String courseid);
